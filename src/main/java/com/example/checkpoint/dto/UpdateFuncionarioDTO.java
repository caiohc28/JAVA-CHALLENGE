...
public class UpdateFuncionarioDTO {
    ...
    private Integer motoId; // Opcional: para alterar ou definir a moto associada. Pode ser null para desassociar.

    // Construtores
    public UpdateFuncionarioDTO() {
    }

    public UpdateFuncionarioDTO(Integer id, String nome, String cpf, String telefone, String tipoFuncionario, Integer motoId) {
        this.id = id;
        this.nome = nome;
        this.cpf = cpf;
